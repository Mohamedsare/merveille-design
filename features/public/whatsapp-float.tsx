...
export function WhatsAppFloat({ number }: { number: string }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center transition-transform hover:scale-105 hover:shadow-[0_6px_20px_rgba(37,211,102,0.45)] active:scale-95"
